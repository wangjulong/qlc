 ...
 */
return [
    'A confirmation message has been sent to your new email address' => '已发送确认邮件到您的新电子邮件地址',
    'A message has been sent to your email address. It contains a confirmation link that you must click to complete registration.' => '已发送邮件到您的电子邮件地址。它包含一个确认链接，您必须单击完成注册。',
    'A message has been sent to your email address. It contains a password that we generated for you.' => '已发送邮件到您的电子邮件地址。它包含了我们为您生成的密码。',
    'A message has been sent to your email address. It contains your password and a confirmation link that you must click to complete registration.' => '已发送邮件到您的电子邮件地址。它包含您的密码和确认链接，您必须单击以完成注册。',
    'A new confirmation link has been sent' => '一个新的确认链接已发送',
    'Account confirmation' => '帐户确认',
    'Account details' => '帐户细节',
    'Account details have been updated' => '已更新帐户细节',
    'An email has been sent with instructions for resetting your password' => '已发送电子邮件的指示重置您的密码',
    'An error occurred and your password has not been changed. Please try again later.' => '发生错误时，您的密码并没有更改。请稍后再试。',
    'An error occurred processing your request' => '处理您的请求时出错',
    'Assignments' => '作业',
    'Awesome, almost there. Now you need to click the confirmation link sent to your new email address' => '真棒，现在你需要点击确认链接发送到您的新的电子邮件地址',
    'Awesome, almost there. Now you need to click the confirmation link sent to your old email address' => '真棒，现在你需要点击确认链接发送到您的旧电子邮件地址',
    'Complete password reset on {0}' => '密码重置',
    'Confirm account on {0}' => '确认帐户',
    'Confirm email change on {0}' => '确认电子邮件更改',
    'Confirmation status' => '确认状态',
    'Confirmation time' => '确认时间',
    'Create' => '创建',
    'Credentials will be sent to the user by email' => '凭据将发送给用户通过电子邮件',
    'Delete' => '删除',
    'Don\'t have an account? Sign up!' => '没有帐号吗? 注册!',
    'In order to finish your registration, we need you to enter your email address' => '为了完成您的注册，我们需要您输入您的电子邮件地址',
    'Invalid or expired link' => '无效或过期链接',
    'New email' => '新的邮件',
    'New permission' => '新的权限',
    'New role' => '新的角色',
    'New user' => '新的用户',
    'Not blocked' => '不阻塞',
    'Permissions' => '权限',
    'Profile details' => '配置细节',
    'Profile details have been updated' => '配置文件已更新',
    'Recovery link is invalid or expired. Please try requesting a new one.' => '',
    'Recovery message sent' => '恢复链接无效或过期。请尝试申请一个新的。',
    'Registration IP' => '注册 IP',
    'Roles' => '角色',
    'Something went wrong' => '未知错误',
    'Something went wrong and your account has not been confirmed.' => '未知错误，你的帐户还没有得到验证。',
    'Thank you, registration is now complete.' => '谢谢您，现在注册完成。',
    'The confirmation link is invalid or expired. Please try requesting a new one.' => '确认链接无效或过期。请尝试重新申请确认链接。',
    'Unconfirmed' => '未通过验证',
    'Update' => '更新',
    'User is not found' => '用户不存在',
    'VKontakte' => '',
    'We have sent confirmation links to both old and new email addresses. You must click both links to complete your request' => '我们已经发送确认链接到旧的和新的电子邮件地址。你必须点击两个链接来完成你的要求',
    'Welcome! Registration is complete.' => '欢迎!注册已经完成。',
    'Yandex' => '',
    'You can assign multiple roles or permissions to user by using the form below' => '您可以使用下面的表格为用户分配多个角色或权限',
    'You can connect multiple accounts to be able to log in using them' => '您可以将多个帐户连接到使用它们的日志中',
    'You can not block your own account' => '你不能阻止你自己的帐户',
    'You can not remove your own account' => '你不能删除你自己的帐户',
    'You can now log in with the following credentials:' => '您现在可以登录以下凭据',
    'Your account details have been updated' => '您的帐户信息已被更新',
    'Your account has been connected' => '您的帐户已被连接',
    'Your account on {0} has been created' => '您的帐户{0}已经创建',
    'Your confirmation token is invalid or expired' => '您的确认令牌无效或过期',
